angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app.html',
    ...
    "            <a href=\"#!/\" class=\"navbar-brand\">ABSTRACT</a>\n" +
    "        </div>\n" + 
    "\n" +
    ...
    "                        <li>\n" +
    "                            <a href=\"https://vijaymanda06.github.io/project-site/\">PROJECT</a>\n" +
    "                        </li>\n" +
    "                    </ul>\n" +
    "                </li>\n" +
    "            </ul>\n" +
  ...
  $templateCache.put('pages/intro/intro.html',
    "<h1>Money Transaction Security Using BlockChain</h1>\n" +
    "\n" +
    "<h3>Many sectors like finance, medicine, manufacturing and education use blockchain applications to profit from the unique bundle of characteristics of this technology. Blockchain technology (BT) promises benefits in trustability, collaboration, organization, identification, credibility and transparency. In this project, we conduct an analysis in which we show how open science can benefit from this technology and its properties. We will use Blockchain here for secure transactions of money between friends.Transaction between friends is secured by using blockchain technology. Here we will see how the transaction is secured and protected.</h3><br/><br/>\n" 
    );
